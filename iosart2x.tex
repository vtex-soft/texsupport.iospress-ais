...
Use \verb|\thanks{}| command for footnotes in
\verb|\title| and \verb|\author| commands.
...
Use the standard \LaTeX{} commands for headings: \verb|\section|, \verb|\subsection|, \verb|\subsubsection|,\break
\verb|\paragraph|. Headings will be automatically numbered.
...
\begin{acks}
Please include your acknowledgements in \verb|acks| environment. For short acknowledgment you may use \verb|ack| environment.\vspace*{-\baselineskip}
\end{acks}
